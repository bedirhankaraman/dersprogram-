...
function renderNetsTable(nets, onDelete) {
...
function renderQuestionsTable(records, onDelete) {
...
function initQuestions(state) {
  ...
  function save() {
    ...
    renderQuestionsTable(state.questions, (id) => {
